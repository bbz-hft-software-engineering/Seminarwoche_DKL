...
task main(){
	...
	displayCenteredBigTextLine(4, "Button druecken,");
	displayCenteredBigTextLine(6, "um Initialisierung");
	displayCenteredBigTextLine(8, "zu starten.");
  ...
  while(getMotorEncoder(turn) <= TURN_RADIUS_MAX){
	...
	displayCenteredBigTextLine(10, "Brown: %d", positionBrown);
